...
class MRC:
    ...
    train_dataset: Optional[DatasetDict] = field(default=None)
    eval_dataset: Optional[DatasetDict] = field(default=None)
    test_dataset: Optional[DatasetDict] = field(default=None)

    do_train = training_args.do_train
    do_eval = training_args.do_eval
    do_predict = training_args.do_predict

    # last_checkpoint = self.check_sanity(config, train_dataset, tokenizer)
